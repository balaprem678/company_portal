...
export class VieworderComponent implements OnInit {
	...
	// 											<td style="vertical-align:top;">23 Nov, 2021 <span style="font-size:12px; color:#878a99 ;">02:36PM</span></td>
	// 											<td style="vertical-align:top;"><i style="background:#dcf6e9; padding:4px 10px; color:#13c56b; font-size:11px; font-style:normal; border-radius: 5px;">Paid</i></td>
	// 											<td style="vertical-align:top;">$755.96</td>
	// 										</tr>
	// 										<tr>
	// 											<td colspan="4" style="height:5px;"></td>
	// 										</tr>
	...
	// 							<tr>
	// 								<td colspan="2" style="width: 100%;">
	// 									<table cellspacing="0" cellpadding="0" border="0" style="width: 100%; border-collapse: collapse; border-bottom:1px dashed #e9ebec;">
	...
	// 															<p style="font-weight:600; color:#495057; margin:0px;">David Nichols</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">305 S San Gabriel Blvd</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Phone: +(123) 456-7890</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Tax: 12-3456789</p>
	// 														</td>
	// 														<td>
	...
	// 									<table cellspacing="0" cellpadding="0" border="0" style="width: 100%; border-collapse: collapse; border-bottom:1px dashed #e9ebec; border-top:1px dashed #e9ebec;">
	// 										<tr style="margin: 0;font-size: 13px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 500; margin-bottom:5px; line-height:24px; Color:#495057; text-align:left;">
	// 											<td width="100%">
	...
	// 														<td>Sweatshirt for Men (Pink) <br><span style="Color:#878a99;">Graphic Print Men & Women Sweatshirt</span></td>
	// 														<td>$119.99</td>
	// 														<td style="text-align:center;">02</td>
	// 														<td style="text-align:right;">$239.98</td>
	// 													</tr>
	// 													<tr>
	// 														<td style="font-weight:600;">02</td>
	// 														<td>Noise NoiseFit Endure Smart Watch <br><span style="Color:#878a99;">32.5mm (1.28 Inch) TFT Color Touch Display</span></td>
	// 														<td>$94.99</td>
	// 														<td style="text-align:center;">01</td>
	// 														<td style="text-align:right;">$94.99</td>
	// 													</tr>
	// 													<tr>
	// 														<td style="font-weight:600;">03</td>
	// 														<td>350 ml Glass Grocery Container <br><span style="Color:#878a99;">Glass Grocery Container (Pack of 3, White)</span></td>
	// 														<td>$24.99</td>
	// 														<td style="text-align:center;">01</td>
	// 														<td style="text-align:right;">$24.99</td>
	// 													</tr>
	// 													<tr>
	// 														<td style="font-weight:600;">04</td>
	// 														<td>Fabric Dual Tone Living Room Chair <br><span style="Color:#878a99;">Chair (White)</span></td>
	// 														<td>$340.00</td>
	// 														<td style="text-align:center;">01</td>
	// 														<td style="text-align:right;">$340.00</td>
	// 													</tr>
	// 													<tr style="border-bottom:1px dashed #e9ebec;">
	// 														<td colspan="5"></td>
	// 													</tr>
	...
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Payment Method: Mastercard</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Card Holder: David Nichols</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Card Number: xxx xxxx xxxx 1234</p>
	// 															<p style="font-weight:500; color:#878a99; margin:0px;">Total Amount: $ 755.96</p>
	// 														</td>
	// 													</tr>
	//                           </table>
	//                             </td>
	// 														<td style="margin: 0;font-size: 13px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 500; margin-bottom:0px; line-height:15px;">Sub Total</td>
	// 														<td style="text-align:right;">$699.96</td>
	// 													</tr>
	// 													<tr style="text-align:center;">
	// 														<td colspan="3"></td>
	// 														<td style="margin: 0;font-size: 13px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 500; margin-bottom:0px; line-height:15px;">Estimated Tax (12.5%)</td>
	// 														<td style="text-align:right;">$44.99</td>
	// 													</tr>
	// 													<tr style="text-align:center;">
	// 														<td colspan="3"></td>
	// 														<td style="margin: 0;font-size: 13px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 500; margin-bottom:0px; line-height:15px;">Discount <span style="font-size:12px; Color:#878a99; font-weight:500;">(VELZON15)<span></td>
	// 														<td style="text-align:right;">- $53.99</td>
	// 													</tr>
	// 													<tr style="text-align:center;">
	// 														<td colspan="3"></td>
	// 														<td style="margin: 0;font-size: 13px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 500; margin-bottom:0px; line-height:15px;">Shipping Charge</td>
	...
	// 														<td style="margin: 0;font-size: 15px; font-weight:bold; font-family: 'Montserrat', sans-serif; font-weight: 700; margin-bottom:5px; line-height:15px; border-top:1px dashed #e9ebec; text-align:right;">$755.96</td>
	// 													</tr>
	// 												</table>
	// 											</td>
	// 										</tr>
