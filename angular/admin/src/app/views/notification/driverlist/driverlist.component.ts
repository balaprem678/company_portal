...
export class DriverlistComponent implements OnInit {
  ...
  constructor(private apiService: ApiService,
    ...
    if (this.curentUser && this.curentUser.role == "subadmin" ) {
      if (this.router.url == '/app/notification/driverlist' && this.curentUser.privileges) {
  ...
  ngAfterViewInit(): void {
    this.apiService.CommonApi(Apiconfig.getdriverlist.method, Apiconfig.getdriverlist.url, {}).subscribe(
      (result) => {
        if (result) {
  ...
  getDataList(data) {
    this.apiService.CommonApi(Apiconfig.getdriverlist.method, Apiconfig.getdriverlist.url, data).subscribe(
      (result) => {
        if (result) {
