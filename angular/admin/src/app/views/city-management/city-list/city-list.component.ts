...
export class CityListComponent implements OnInit {
  ...
  addBtnUrl: string = '/app/cityManagement/add';
  editUrl: string = '/app/cityManagement/edit/';
  card_details: any[] = [];
  ...
  constructor(
    ...
    if (this.curentUser && this.curentUser.role == "subadmin" && this.curentUser.privileges) {
      if (this.router.url == '/app/cityManagement/list') {
  ...
  getdata(data) {
    this.apiService.CommonApi(Apiconfig.cityList.method, Apiconfig.cityList.url, data).subscribe(response => {
      ...
      this.settings = {
        ...
        columns: {
          ...
          _id: {
            ...
            type: "html",
            valuePrepareFunction: value => {
              return `<a href='/#/app/drivers/driverorder/${value}'><span>Fare</span></a>`
            }
          }
        },
        pager: {
      ...
      this.settings = {
        ...
        columns: {
          ...
          _id: {
            ...
            type: "html",
            valuePrepareFunction: value => {
              return `<a href='#/app/cityManagement/city_fare/${value}' target="_blank"><button class="city fare">Fare</button></a>` + " " + `<a href='#/app/cityManagement/city_warehouse/${value}' target="_blank"><span><button class="city warehouse">Ware House</button></span></a>` + " " + `<a href='#/app/cityManagement/city_area_list/${value}' target="_blank"><span><button class="city viewarea">View Areas</button></span></a>` + " " + `<a href='#/app/cityManagement/city_area/${value}' target="_blank"><button class="city addarea"><span>Add Area</span></button></a>`
            }
          }
        },
        pager: {
