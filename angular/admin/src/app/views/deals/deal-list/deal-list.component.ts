...
export class DealListComponent {
  ...
  addBtnUrl: string = '/app/deals/add';
  addBtnName: string = 'Add Deals';
  editUrl: string = `/app/deals/edit/`;
  viewUrl: string = `/app/deals/view/`;
  ...
  constructor(
    ...
    if (this.curentUser && this.curentUser.doc.role == "subadmin") {
      if (this.router.url == '/app/deals/list' && this.curentUser.doc.privileges) {
        this.userPrivilegeDetails = this.curentUser.doc.privileges.filter(x => x.alias == 'deals');
  ...
  getdata(data) {
    ...
    this.apiService.CommonApi(Apiconfig.dealList.method, Apiconfig.dealList.url, data).subscribe(response => {
      console.log("+++++++++++++++++++++++");
