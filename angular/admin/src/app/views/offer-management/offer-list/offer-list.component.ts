...
export class OfferListComponent {
  ...
  addBtnUrl: string = '/app/offer/add';
  addBtnName: string = 'Add Offer';
  editUrl: string = `/app/offer/edit/`;
  viewUrl: string = `/app/offer/view/`;
  ...
  deleteApis: apis = Apiconfig.offerDelete;
  productDetails: any;
  error: any;
  disable: any = [];
  constructor(
