...
export class SubscriptionlistComponent implements OnInit {
  ...
  addBtnUrl: string = '/app/subscription/add';
  addBtnName: string = 'Subscription Add';
  editUrl: string = '/app/subscription/edit/';
  deleteApis: apis = Apiconfig.subscriptionDelete;
  card_details: any[] = [];
  ...
  constructor(
    ...
    if (this.curentUser && this.curentUser.role == "subadmin") {
      if (this.router.url == '/app/subscription/list') {
  ...
  loadsettings(event) {
    if (event == 'delete') {
      ...
      this.settings.actions.custom = this.getSettings.loadSettings(event, this.curentUser, '/app/subscription/list', this.userPrivilegeDetails, this.delete_btn, this.edit_btn, this.view_btn);
    } else {
      this.settings = {
        selectMode: 'multi',
        hideSubHeader: true,
