    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content cases-model">
            <div class="modal-body">
                <h6> Do you want to Assign driver? </h6>
            </div>
...
export class Assign_driverComponent {
    rowData: any;
    @Input() value: any;
