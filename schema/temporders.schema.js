...
var TEMPORDERS_SCHEMA = {};

TEMPORDERS_SCHEMA.TEMPORDERS = {
    ...
    status: Number,// 0-Deleted,1-order received,2-restaurant rejected,3-restaurant acepted,4-driver rejected,5-driver acepted,6-driver pickedup,7-deliverd,8-payment completed,9-cancelled by user,10-admin cancelled oreder,15-scheduled
...
module.exports = TEMPORDERS_SCHEMA;
